 ...
 <section className='flex px-10 w-[100%] h-[92vh] shadow-md bg-[#F6F6F6]'>
                <div className='flex px-5 gap-5  py-5 w-[100%]  h-[100%] '>
                    <div className='flex flex-col px-4 mt-36 z-10'>
                        <p className='text-[70px] text-black font-bold tracking-wider leading-[70px]'>Welcome, Educator!</p>
                        <p className='text-[16px] font-semibold tracking-wider mt-10 w-[390px] leading-none'>Whether you're here to upload course materials, moderate discussions, or grade assignments, we're here to make your teaching journey seamless and rewarding.</p>
                        <p className='mt-10 text-[14px] text-gray-600' >If you haven't joined us, <Link className='text-black font-semibold' href={"/signup/teacher"} >Register here</Link></p>
                    </div>
