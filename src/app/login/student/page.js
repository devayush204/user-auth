        ...
        <>
            <section className='flex px-10 w-[100%] h-[92vh] shadow-md bg-[#F6F6F6]'>
                <div className='flex px-5 gap-5  py-5 w-[100%]  h-[100%] '>
                    <div className='flex flex-col px-4 mt-36 z-10'>
                    ...
                    <div className='mt-52 absolute ml-[370px] '>
                        <img className='w-[450px] h-[400px]  ' src={"/loginimg.png"} alt="" />
                    </div>
                </div>
                {/* login details  */}
                <div className='px-10 py-4 w-[70%] flex flex-col items-center justify-center '>
                    <div className='flex flex-col w-[370px] px-4 py-8  shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.5)_0px_3px_7px_-3px]'>
                        <div className="relative ">
                            ...
                            <input type="text" className="focus:outline-none  text-gray-400 text-sm rounded-lg block w-full pl-10  py-3 border border-gray-200 placeholder-gray-400 " placeholder="name@gmail.com" value={user.email} 
                        ...
                        <div className='flex items-center mt-5 w-[100%]'>
                            <Button className="w-[100%]" color="primary" variant="shadow" onClick={onLogin}>
                                Log In
                            </Button>
                        </div>
